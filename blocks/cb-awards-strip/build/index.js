...
/***/ "./blocks/cb-awards-strip/src/edit.js"
/*!********************************************!*\
  !*** ./blocks/cb-awards-strip/src/edit.js ***!
  \********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function Edit({
  ...
  const awardsMedia = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => awards.length ? awards.map(id => select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_4__.store).getMedia(id)).filter(Boolean) : [], [awards]);
  function removeAwardsImage(id) {
    setAttributes({
      awards: awards.filter(imageId => imageId !== id)
    });
  }
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_shared_EditorBlockShell__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("label", {
        ...
        children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Awards", "cb-chillibyte-2026")
      }), awardsMedia.length > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("ul", {
        ...
        children: awardsMedia.map(item => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("li", {
          style: {
            position: "relative"
          },
      ...
      }), awards.length === 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("p", {
        className: "cb-chillibyte-2026-editor-field__help",
        children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("No images selected — the site-wide Awards Gallery from Site-Wide Settings will be shown. Select images here to override it for this block only.", "cb-chillibyte-2026")
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
          onSelect: selected => setAttributes({
            awards: selected.map(item => item.id)
          }),
          allowedTypes: ["image"],
          multiple: true,
          gallery: true,
          ...
          render: ({
            ...
            variant: "secondary",
            onClick: open,
            children: awards.length ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Edit Gallery", "cb-chillibyte-2026") : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Select Images", "cb-chillibyte-2026")
          })
        })
      })]
    })
...
/***/ "./blocks/cb-awards-strip/block.json"
/*!*******************************************!*\
  !*** ./blocks/cb-awards-strip/block.json ***!
  \*******************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"cb-chillibyte-2026/cb-awards-strip","title":"CB Awards Strip","category":"cb-chillibyte-2026","icon":"cover-image","attributes":{"awards":{"type":"array","default":[]}},"supports":{"anchor":true,"className":true,"align":true,"color":{"background":true,"text":true}},"editorScript":"file:./build/index.js","render":"file:./render.php"}');
...
(() => {
/*!*********************************************!*\
  !*** ./blocks/cb-awards-strip/src/index.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./blocks/cb-awards-strip/src/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../block.json */ "./blocks/cb-awards-strip/block.json");
