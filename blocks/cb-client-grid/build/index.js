...
/***/ "./blocks/cb-client-grid/src/edit.js"
/*!*******************************************!*\
  !*** ./blocks/cb-client-grid/src/edit.js ***!
  \*******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function Edit({
  ...
  const logosMedia = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => logos.length ? logos.map(id => select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_4__.store).getMedia(id)).filter(Boolean) : [], [logos]);
  function removeLogosImage(id) {
    setAttributes({
      logos: logos.filter(imageId => imageId !== id)
    });
  }
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_shared_EditorBlockShell__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("label", {
        ...
        children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Logos", "cb-chillibyte-2026")
      }), logosMedia.length > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("ul", {
        ...
        children: logosMedia.map(item => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("li", {
          style: {
            position: "relative"
          },
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
          onSelect: selected => setAttributes({
            logos: selected.map(item => item.id)
          }),
          allowedTypes: ["image"],
          multiple: true,
          gallery: true,
          ...
          render: ({
            ...
            variant: "secondary",
            onClick: open,
            children: logos.length ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Edit Gallery", "cb-chillibyte-2026") : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Select Images", "cb-chillibyte-2026")
          })
        })
      })]
    })
...
/***/ "./blocks/cb-client-grid/block.json"
/*!******************************************!*\
  !*** ./blocks/cb-client-grid/block.json ***!
  \******************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"cb-chillibyte-2026/cb-client-grid","title":"CB Client Grid","category":"cb-chillibyte-2026","icon":"cover-image","attributes":{"logos":{"type":"array","default":[]}},"supports":{"anchor":true,"className":true,"align":true,"color":{"background":true,"text":true}},"editorScript":"file:./build/index.js","render":"file:./render.php"}');
...
(() => {
/*!********************************************!*\
  !*** ./blocks/cb-client-grid/src/index.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./blocks/cb-client-grid/src/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../block.json */ "./blocks/cb-client-grid/block.json");
