 ...
 * @return void
 */
function cb_chillibyte_2026_register_post_types() {
...
add_action( 'init', 'cb_chillibyte_2026_register_post_types' );
 ...
 * @return string
 */
function cb_chillibyte_2026_use_page_template_for_cpts( $template ) {
...
add_filter( 'template_include', 'cb_chillibyte_2026_use_page_template_for_cpts' );
